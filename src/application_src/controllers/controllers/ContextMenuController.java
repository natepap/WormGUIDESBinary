...
public class ContextMenuController extends AnchorPane implements Initializable {
    ...
    private Map<String, TreeItem<String>> binNameMap;
    ...
    public ContextMenuController(
            ...
            final Map<String, TreeItem<String>> binNameMap) {
                            ...
                            if (results != null) {
                                for (String res : results) {
                                    ...
                                    item.setOnAction(event12 -> {
                                        ...
                                        // because we're searching a term that was generated by a wormbase search itself
    ...
    public void setName(String name) {
        ...
        if(binNameMap.containsKey(cellName.toLowerCase())){
            nameText.setText("Traditional Name: " + name + "\n Binary Name: " + binNameMap.get(cellName.toLowerCase()).getValue());
        }else{
            nameText.setText("Traditional Name: " + name);
        }
    }
