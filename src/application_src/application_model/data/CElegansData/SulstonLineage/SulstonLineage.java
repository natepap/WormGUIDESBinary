...
public class SulstonLineage {
    ...
    private static final String[] specialCasesAsLowerCaseStringArray = {"p0", "ab", "p1", "p2", "ems", "e", "ms", "c", "p3", "d", "p4", "z3", "z2"};
    ...
    public static String[] getSpecialCasesAsLowerCaseStringArray() {
        return specialCasesAsLowerCaseStringArray;
    }
}